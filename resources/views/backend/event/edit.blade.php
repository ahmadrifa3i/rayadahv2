                          ...
                          <div class="row">
                            <div class="col-lg-12">
                              <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                ...
                                <textarea class="form-control summernote" name="{{ $language->code }}_refund_policy" 
                                  placeholder="Enter Refund Policy" data-height="300">{{ @$event_content->refund_policy }}</textarea>
                              </div>
                            </div>
                          </div>
