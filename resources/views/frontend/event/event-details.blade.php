...
@section('content')
          ...
          <div class="buttons">
            ...
            <a href="javascript:void(0)" data-toggle="modal" data-target=".share-event">
              <i class="fas fa-share-alt"></i></a>
                              ...
                              <a href="/assets/admin/file/attachments/event/1.pdf" download
                                class="btn" style="color: #007bff;"><i class="fas fa-download"></i>{{ __('Download') }}</a>
          ...
          <div class="col-lg-7">
            <div class="event-details-content-inner">
              ...
              @if (!empty($content->refund_policy))
                <h3 id="refund_policy">{{ __('Return Policy') }}</h3>
                <div class="summernote-content">
                {!! $content->refund_policy !!}</p>
                </div>
              @endif
  ...
  <label class="form-check-label" for="terms">
         انا اوافق على          
    <a href="#refund_policy" onclick="scrollToRefundPolicy(event)" style="color: #007bff;">القواعد والشروط</a>
  </label>
</div>
...
@endsection
<script>
function scrollToRefundPolicy(event) {
  event.preventDefault(); // Prevent the default anchor link behavior
  const refundPolicySection = document.getElementById('refund_policy');
  refundPolicySection.scrollIntoView({ behavior: 'smooth', block: 'start' });
}
</script>